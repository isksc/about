const commandList = {
  ...
  contact: {
    ...
    messages: [
      { message: "Website: https://shancn.com" },
      { message: "Blog: https://blog.shancn.com" },
      { message: "Email: upshan@outlook.com" },
      { message: "Github: https://github.com/isksc" },
    ],
  },
  about: {
    ...
    messages: [
      {
        message:
          "My name is chen kaishan. I'm a programmer, You can visit my personal website at https://shancn.com to learn more about me.",
      },
    ],
  },
  // readme: {
